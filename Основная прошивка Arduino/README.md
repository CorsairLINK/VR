...
- Светодиод "POW" на плате Arduino сигнализирует о наличии питания. Светодиод "TX" должен быстро мигать, сигнализируя отправку данных по Serial port. Если после прошивки или не корректной работы, эти светодиоды горят не правильно - переподключите контроллер (Или перезапустите нажав кнопку на плате)</br>

<img src="https://user-images.githubusercontent.com/75369161/223391851-c32bb22c-3b1f-4e82-85dd-6c59c9d645a4.jpg" width=50% height=50%><br/>
